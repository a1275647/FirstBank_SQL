...
SET @FilegroupSql += N'CREATE TABLE [dbo].[CreditRating_Country_Current_Week](
 ...
 CONSTRAINT [PK_CreditRating_Country_Current_Week] PRIMARY KEY CLUSTERED
(
    [PK_Id] ASC
) ON [NCRMS_TAB],
 CONSTRAINT [UQ_CreditRating_Country_Current_Week_Period_Agency_Country] UNIQUE NONCLUSTERED
(
    [Year] ASC,
    [Month] ASC,
    [Week] ASC,
...
-- Resolve optional named filegroups at execution time; PRIMARY is the portable fallback.
DECLARE @FilegroupSql nvarchar(max) = N'';
SET @FilegroupSql += N'CREATE NONCLUSTERED INDEX [IX_CreditRating_Country_Current_Week_Year_Month_Week] ON [dbo].[CreditRating_Country_Current_Week]
(
    [Year] ASC,
    [Month] ASC,
    [Week] ASC
